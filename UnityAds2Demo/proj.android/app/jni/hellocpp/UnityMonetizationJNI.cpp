...
#define LOG_TAG    "UnityMonetizationJNI"
#define LOGD(...)  __android_log_print(ANDROID_LOG_DEBUG,LOG_TAG,__VA_ARGS__)

#define CLASS_NAME "org/cocos2dx/cpp/UnityMonetizationJNI"
...
JNIEXPORT void JNICALL Java_org_cocos2dx_cpp_UnityMonetizationJNI_reward (JNIEnv * env, jobject jobj, jstring zoneid)
{
    char* ret = NULL;
...
bool UnityAdsBannerShown(const char *parameter)
{
    ...
    if (! JniHelper::getStaticMethodInfo(methodInfo, CLASS_NAME, "UnityAdsBannerShown", "(Ljava/lang/String;)Z"))
    {
        LOGD("Failed to find static method of UnityAdsBannerShown");
        return false;
    }

    jstring placementId = methodInfo.env->NewStringUTF(parameter);
    jboolean shown = (jboolean)methodInfo.env->CallStaticBooleanMethod(methodInfo.classID, methodInfo.methodID, placementId);
    if(JNI_TRUE == shown) return true;
    return false;
}
...
void UnityAdsShowBanner(const char *parameter)
{
    ...
    if (! JniHelper::getStaticMethodInfo(methodInfo, CLASS_NAME, "UnityAdsShowBanner", "(Ljava/lang/String;)V"))
    {
        LOGD("Failed to find static method of UnityAdsShowBanner");
        return;
    }
...
void UnityAdsHideBanner(const char *parameter)
{
    ...
    if (! JniHelper::getStaticMethodInfo(methodInfo, CLASS_NAME, "UnityAdsHideBanner", "(Ljava/lang/String;)V"))
    {
        LOGD("Failed to find static method of UnityAdsHideBanner");
        return;
    }
