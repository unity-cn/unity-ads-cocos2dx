...
extern "C" {
    ...
    void UnityAdsInit(const char* parameter, bool testMode) {
        ...
        if (! JniHelper::getStaticMethodInfo(methodInfo, CLASS_NAME, "UnityAdsInit", "(Ljava/lang/String;Z)V"))
        {
            LOGD("Failed to find static method of UnityAdsInit");
            return;
        }
    ...
    bool UnityAdsHideBanner()
    {
        JniMethodInfo methodInfo;

        if (! JniHelper::getStaticMethodInfo(methodInfo, CLASS_NAME, "UnityAdsHideBanner", "()Z"))
        {
    ...
    bool UnityAdsBannerShown()
    {
        ...
        if (! JniHelper::getStaticMethodInfo(methodInfo, CLASS_NAME, "UnityAdsBannerShown", "()Z"))
        {
